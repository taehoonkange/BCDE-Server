...
public class BoastPostInfoDto {
    ...
    public static class Response {
        ...
        private List<BoastImgUrlDto> imgUrl = new ArrayList<>(); // 이미지 리스트
        private List<BoastHashTagDto> hashTag = new ArrayList<>(); // 해시태그 리스트
        ...
        public Response(BoastPost boastPost) {
            ...
            this.imgUrl = boastPost.getBoastImgUrlList().stream()
                    .map(boastImgUrl -> new BoastImgUrlDto(boastImgUrl))
                    .collect(Collectors.toList());
            this.hashTag = boastPost.getBoastHashTagList().stream()
