...
public class BoastPostSearchPagingDto {
    ...
    private List<BriefBoastPostSearchInfoDto> simpleLectureDtoList = new ArrayList<>();


    public BoastPostSearchPagingDto(Page<BoastHashTag> searchResults) {
        ...
        this.simpleLectureDtoList = searchResults.getContent().stream().map(BriefBoastPostSearchInfoDto::new).collect(Collectors.toList());
    }
}