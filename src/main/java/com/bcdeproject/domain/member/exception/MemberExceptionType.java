...
public enum MemberExceptionType implements BaseExceptionType {
    ...
    MEMBER_UPDATE_ORIGINAL_IMAGE_NOT_FOUND(604, HttpStatus.BAD_REQUEST, "업데이트할 회원의 기존 프로필 사진을 입력해주세요."),
    MEMBER_DELETE_IMAGE_NOT_FOUND(605, HttpStatus.BAD_REQUEST, "삭제할 회원의 프로필 사진을 입력해주세요.");
